...
/**
 * Admin dashboard — displays the agent's internal reasoning logs:
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4">
        <div>
          ...
          <p className="text-xs text-gray-500">Agent reasoning logs &amp; refund decisions</p>
        </div>
